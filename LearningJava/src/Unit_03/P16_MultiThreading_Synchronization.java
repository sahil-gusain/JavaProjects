...
*
*where we shared resources we use synchronization
*JVM has a main thread which executes main first 
*
*/
...
public class P16_MultiThreading_Synchronization {
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    System.out.println(Thread.currentThread().getName());// it will print main(thread)
    ...
    threadOne.join();
    //join method says ki jab tk mera kam nahi hoga tab tk main thread na chale
    //Waits for this thread to die. {Main thread will wait untill this thread is finished}
    threadTwo.join();
